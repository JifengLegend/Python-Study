...
if __name__ == "__main__":
    ...
    if tarWin==None:
        ...
        pocache=pyautogui.locateOnScreen('target.png',region=(tarWin.topleft.x,tarWin.topleft.y,tarWin.size.width,tarWin.size.height))
        bx,by=pyautogui.center(pocache)
        print(bx-tarPos[0],by-tarPos[1])
        getPosition(bx-tarPos[0],by-tarPos[1])
